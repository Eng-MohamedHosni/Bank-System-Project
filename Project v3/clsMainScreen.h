...
private:
    enum enMainMenueOptions {
        ...
        eManageUsers = 7, eLoginRegister = 8,eCurrencyExhangeMenue=9, eExit =10
    };
    ...
    {
        clsLoginResgisterScreen::ShowLoginRegisterScreen();
    }

    static void _ShowCurrencyExchangeMainScreen()
    {
        clsCurrencyExchangeMainScreen::ShowCurrencyExhangeMainScreen();
    }
    ...
    static void _PerfromMainMenueOption(enMainMenueOptions MainMenueOption)
    {
        ...
        case enMainMenueOptions::eLoginRegister:
            ...
            _GoBackToMainMenue();
            break;
        case enMainMenueOptions::eCurrencyExhangeMenue:
            system("cls");
